...
function NewCal(pCtrl,pFormat,pScroller,pShowTime,pTimeMode,pHideSeconds) {
...
function RenderCssCal(bNewCal) {
  ...
  //******************End Month and Year selector in arrow******************************
	...
	xpos=(document.body.clientWidth/2)-(CalWidth/2);
	ypos=(document.body.clientHeight/2)-(calHeight/2);
